...
namespace NetworkSystemFinder.Helpers
{
    static class WMICHelper
    {
        ...
        static ObjectQuery queryAccount = new ObjectQuery("SELECT * FROM Win32_Account");
        ...
        static ObjectQuery queryNetwork = new ObjectQuery("SELECT * FROM Win32_NetworkAdapterConfiguration");
